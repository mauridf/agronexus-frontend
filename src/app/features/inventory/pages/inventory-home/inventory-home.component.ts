...
@Component({
  ...
  template: `
    <div class="page-container">
      <div class="page-header">
        ...
        <p class="page-subtitle">Gerencie insumos, compras e estoque</p>
      </div>

      <div class="hub-grid">
        <mat-card class="hub-card" routerLink="/inventory/inputs">
          <mat-card-content>
            <div class="hub-icon"><mat-icon>category</mat-icon></div>
            <h2>Catálogo de Insumos</h2>
            <p>Cadastre e gerencie os tipos de insumo (fertilizantes, sementes, etc.)</p>
          </mat-card-content>
          <mat-card-actions>
        ...
        <mat-card class="hub-card" routerLink="/inventory/purchase">
          <mat-card-content>
            <div class="hub-icon"><mat-icon>shopping_cart</mat-icon></div>
            <h2>Registrar Compra</h2>
            <p>Registre a compra de insumos para uma fazenda</p>
          </mat-card-content>
          <mat-card-actions>
        ...
        <mat-card class="hub-card" routerLink="/inventory/stock">
          <mat-card-content>
            <div class="hub-icon"><mat-icon>warehouse</mat-icon></div>
            <h2>Estoque</h2>
            <p>Visualize o estoque de insumos por fazenda</p>
          </mat-card-content>
          <mat-card-actions>
            <button mat-button color="primary">VISUALIZAR</button>
          </mat-card-actions>
        </mat-card>
      </div>
    </div>
  ...
  styles: [`
    ...
    .hub-card {
      cursor: pointer; transition: transform 0.2s, box-shadow 0.2s; border-radius: 12px;
